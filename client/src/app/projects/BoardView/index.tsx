...
const TaskColumn = ({
    ...
    setIsModalNewTaskOpen,
        ...
        return (
            ...
            className={`sl:py-4 rounded-lg py-2 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neural-950" : ""}`}
            >
                <div className="mb-3 flex w-full">
                    ...
                    />
                    <div className="flex w-full items-center justify-content justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
                        <h3 className="flex items-center text-lg font-semibold dark:text-white">
                            {status}{" "}
                            <span
                                className="ml-2 inline-block rounded-full bg-gray-200 p-[0.37rem] text-center text-sm leading-none dark:bg-dark-tertiary"
            ...
            >
                ...
                <div className="p-4 md:p-6">
                    <div className="flex items-start justify-between">
                        ...
                        <button className="flex h-6 w-4 flex-shrink-0 items-center jusitfy-center dark:text-neutral-500">
                            <EllipsisVertical size={26} />
                        </button>   
                    </div>
                    ...
                    <div className="mt-3 flex items-center justify-between">
                        ...
                        <div className="flex items-center text-gray-500 dark:text-neutral-500">
                            ...
                            <span className="m-1 text-sm dark:text-neutral-400">
                                {numberOfComments}
                            </span>
                        </div>
                    </div>
