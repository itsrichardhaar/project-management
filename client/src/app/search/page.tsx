...
const Search = () => {
    ...
    useEffect(() => {
        return () => {
            handleSearch.cancel(); // properly calling the cancel function
        };
    }, [handleSearch]);
        ...
        <div className="p-8">
            ...
            <div>
                <input
                    type="text"
                    placeholder="Search..."
                    className="w-1/2 rounder border p-3 shadow"
            ...
            <div className="p-5">
                ...
                {!isLoading && !isError && searchResults && (
                    <div>
                        ...
                        {searchResults.projects && searchResults.projects.length > 0 && <h2>Projects</h2>}
