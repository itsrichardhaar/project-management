  ...
  return (
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3">
      ...
      {!isSidebarCollapsed ? null : (
        ...
        <div className="relative flex h-main w-[200px]">
          <Search className="absolute left-[4px] top-1/2 mr-2 h-5 w-5 -translate-y-1/2 cursor-pointer dark:text-white" />
            <input className="w-full rounded border-none bg-gray-100 p-2 pl-8 placholder-gray-500 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-white dark:placeholder:text-white" 
            type="search" 
            placeholder="Search..."
            />
        </div>
      ...
      <div className="flex items-center">
        <button onClick={() => dispatch(setIsDarkMode(!isDarkMode))} className={isDarkMode
