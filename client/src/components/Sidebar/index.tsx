...
import { AlertCircle, AlertOctagon, AlertTriangle, Briefcase, ChevronDown, ChevronUpIcon, Home, Icon, Layers3, LockIcon, LucideIcon, Search, Settings, ShieldAlert, User, Users, X } from 'lucide-react';
    ...
    <div className={sidebarClassNames}>
        <div className="flex h-[100%] w-full flex-col justify-start">
            ...
            <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
                <Image src="https://project-management-s3-images.s3.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
                <div>
